#Практикум "Объектно ориентированное программирование" Игра "Пьяница"
...
class Card:
    ...
    values = [None, None, '2', '3', '4', '5', '6', '7', '8', '9', '10', 'валета',
              'даму', 'короля', 'туза']
...
class Game:
    ...
    def play_game(self):
        ...
        print('Поехали!')
        while len(cards) >= 2:
            m = 'Нажмите X для выхода. Нажмите любую другую клавишу длая начала игры.'
            response = input(m)
            if response == 'X':
                break
